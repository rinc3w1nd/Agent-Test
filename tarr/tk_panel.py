...
def start_tk_panel(loop, page, cfg: Dict, audit, corpus_ctrl):
    ...
    root.geometry("760x400")  # 5-row layout space
    ...
    tk.Button(frm, text="Send Both", width=14, command=with_status("Both", command=lambda: (do_send_at, do_send_corpus))).grid(row=2, column=2, padx=6, pady=4)
